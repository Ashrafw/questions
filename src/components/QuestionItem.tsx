...
export default function QuestionItem({ question, setAnswers }: Props) {
  ...
  return (
    <div className="mb-8">
      <p className=" text-xl max-sm:text-base font-medium  min-h-24 ">
        {question.question}
      </p>
      <div className=" grid grid-cols-2 gap-4 mt-2">
        <button
          onClick={() => handleClick("yes")}
          className={` border flex items-center text-lg max-sm:text-base cursor-pointer rounded-lg shadow p-2 pl-4 ${
